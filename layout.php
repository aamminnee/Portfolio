...
<head>
    ...
    } elseif (isset($pageType) && $pageType === 'skill-detail') {
        // // on lie le css détaillé pour la page de compétence
        echo '<link rel="stylesheet" href="public/css/skills_detail.css?v='.time().'">';
...
<body>
    ...
    <main>
        <?php 
        // // inclusion de la vue déterminée dans index.php (c'est ce bloc qui manquait !)
